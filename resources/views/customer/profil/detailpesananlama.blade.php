  ...
  <div class="row mt-3">
    <ul class="nav nav-tabs" id="myTab" role="tablist">
      <li class="nav-item" role="presentation">
        <a class="nav-link active" id="diajukanCustomer-tab" href="#diajukanCustomer" data-bs-toggle="tab"
          data-bs-target="#diajukanCustomer" role="tab" aria-controls="diajukanCustomer" aria-selected="true">Diajukan
          Customer</a>
      </li>
      <li class="nav-item" role="presentation">
        <a class="nav-link" id="diajukanSalesman-tab" href="#diajukanSalesman" data-bs-toggle="tab"
          data-bs-target="#diajukanSalesman" role="tab" aria-controls="diajukanSalesman"
          aria-selected="false">Diajukan Salesman</a>
      </li>
      <li class="nav-item" role="presentation">
        <a class="nav-link" id="dikonfirmasiAdministrasi-tab" href="#dikonfirmasiAdministrasi" data-bs-toggle="tab"
          ...
          aria-selected="false">Dikonfirmasi Administrasi</a>
      </li>
      <li class="nav-item" role="presentation">
        <a class="nav-link" id="dalamPerjalanan-tab" href="#dalamPerjalanan" data-bs-toggle="tab"
          data-bs-target="#dalamPerjalanan" role="tab" aria-controls="dalamPerjalanan" aria-selected="false">Dalam
          Perjalanan</a>
      </li>
      <li class="nav-item" role="presentation">
        ...
        <div class="container">
          @foreach ($diajukanCustomers as $diajukanCustomer)
            <div class="row border border-1">
              ...
              <button type="button" class="btn btn-primary w-50 my-2 mx-2" data-bs-toggle="modal"
                data-bs-target="#order{{ $diajukanCustomer->id }}">
                Lihat Detail >>>
              </button>

              <!-- Modal -->
              <div class="modal fade" id="order{{ $diajukanCustomer->id }}" tabindex="-1"
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-5">
                          <h5 class="fw-normal">
                            {{ date('d F Y', strtotime($diajukanCustomer->linkOrderTrack->waktu_order)) }}</h5>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-5">
        ...
        <div class="container">
          @foreach ($diajukanSalesmans as $diajukanSalesman)
            <div class="row border border-1">
              ...
              <h5 class="fw-normal">
                {{ date('d F Y', strtotime($diajukanSalesman->linkOrderTrack->waktu_diteruskan)) }}</h5>
              <button type="button" class="btn btn-primary w-50 my-2 mx-2" data-bs-toggle="modal"
                data-bs-target="#order{{ $diajukanSalesman->id }}">
                Lihat Detail >>>
              </button>

              <!-- Modal -->
              <div class="modal fade" id="order{{ $diajukanSalesman->id }}" tabindex="-1"
                aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">
                        {{ $diajukanSalesman->linkInvoice->nomor_invoice }}</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-5">
                          <h5 class="fw-normal">
                            {{ number_format($diajukanSalesman->linkInvoice->harga_total, 0, '', '.') }}</h5>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-5">
        ...
        <div class="container">
          @foreach ($dikonfirmasiAdministrasis as $dikonfirmasiAdministrasi)
            <div class="row border border-1">
              ...
              <h5 class="fw-normal">Rp
                {{ number_format($dikonfirmasiAdministrasi->linkInvoice->harga_total, 0, '', '.') }}</h5>
              <h5 class="fw-normal">
                {{ date('d F Y', strtotime($dikonfirmasiAdministrasi->linkOrderTrack->waktu_dikonfirmasi)) }}</h5>
              <button type="button" class="btn btn-primary w-50 my-2 mx-2" data-bs-toggle="modal"
                data-bs-target="#order{{ $dikonfirmasiAdministrasi->id }}">
                Lihat Detail >>>
              </button>
              ...
              <div class="modal fade" id="order{{ $dikonfirmasiAdministrasi->id }}" tabindex="-1"
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">
                        {{ $dikonfirmasiAdministrasi->linkInvoice->nomor_invoice }}</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-5">
                          <h5 class="fw-normal">
                            {{ date('d F Y', strtotime($dikonfirmasiAdministrasi->linkOrderTrack->waktu_dikonfirmasi)) }}
                          </h5>
                        </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-5">
                          <h5 class="fw-normal">
                            {{ $dikonfirmasiAdministrasi->linkOrderTrack->linkStaffPengonfirmasi->nama }}</h5>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-5">
                        ...
                        <div class="col-5">
                          <h5 class="fw-normal">{{ $dikonfirmasiAdministrasi->linkInvoice->linkEvent->nama ?? '-' }}
                          </h5>
                        </div>
                      </div>
                      ...
                      @elseif($dikonfirmasiAdministrasi->linkInvoice->linkEvent && $dikonfirmasiAdministrasi->linkInvoice->linkEvent->potongan != null)
                        <div class="row">
                          ...
                          <div class="col-5">
                            <h5 class="fw-normal">{{ $dikonfirmasiAdministrasi->linkInvoice->linkEvent->potongan }}
                            </h5>
                          </div>
                        </div>
                      @endif
        ...
        <div class="container">
          @foreach ($dalamPerjalanans as $dalamPerjalanan)
            <div class="row border border-1">
              ...
              <h5 class="fw-normal">{{ date('d F Y', strtotime($dalamPerjalanan->linkOrderTrack->waktu_berangkat)) }}
              </h5>
              <button type="button" class="btn btn-primary w-50 my-2 mx-2" data-bs-toggle="modal"
                data-bs-target="#order{{ $dalamPerjalanan->id }}">
                Lihat Detail >>>
              </button>
              ...
              <div class="modal fade" id="order{{ $dalamPerjalanan->id }}" tabindex="-1"
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">
                        {{ $dalamPerjalanan->linkInvoice->nomor_invoice }}</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-5">
                          <h5 class="fw-normal">
                            {{ date('d F Y', strtotime($dalamPerjalanan->linkOrderTrack->waktu_berangkat)) }}</h5>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-5">
                        ...
                        <div class="col-5">
                          <h5 class="fw-normal">{{ $dalamPerjalanan->linkOrderTrack->linkStaffPengonfirmasi->nama }}
                          </h5>
                        </div>
                      </div>
                      <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-5">
                          <h5 class="fw-normal">
                            {{ number_format($dalamPerjalanan->linkInvoice->harga_total, 0, '', '.') }}</h5>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-5">
        ...
        <div class="container">
          @foreach ($telahSampais as $telahSampai)
            <div class="row border border-1">
              ...
              <button type="button" class="btn btn-primary w-50 my-2 mx-2" data-bs-toggle="modal"
                data-bs-target="#order{{ $telahSampai->id }}">
                Lihat Detail >>>
              </button>
              ...
              <div class="modal fade" id="order{{ $telahSampai->id }}" tabindex="-1"
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">{{ $telahSampai->linkInvoice->nomor_invoice }}
                      </h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-5">
                          <h5 class="fw-normal">
                            {{ date('d F Y', strtotime($telahSampai->linkOrderTrack->waktu_sampai)) }}</h5>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-5">
                      ...
                      <div class="row">
                        ...
                        <div class="col-5">
                          <h5 class="fw-normal">{{ number_format($telahSampai->linkInvoice->harga_total, 0, '', '.') }}
                          </h5>
                        </div>
                      </div>
                      <div class="row">
        ...
        <div class="container">
          @foreach ($ditolaks as $ditolak)
            <div class="row border border-1">
              ...
              <button type="button" class="btn btn-primary w-50 my-2 mx-2" data-bs-toggle="modal"
                data-bs-target="#order{{ $ditolak->id }}">
                Lihat Detail >>>
              </button>

              <!-- Modal -->
              <div class="modal fade" id="order{{ $ditolak->id }}" tabindex="-1"
                aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-5">
                          <h5 class="fw-normal">
                            {{ date('d F Y', strtotime($ditolak->linkOrderTrack->waktu_dikonfirmasi)) }}</h5>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-5">
