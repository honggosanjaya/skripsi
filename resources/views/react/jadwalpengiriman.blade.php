...
@section('main_content')
  <div class="page_container pt-4">
    ...
    <h1 class="fs-6 fw-bold mb-4">Data Pengiriman</h1>
    ...
    <div class="perlu_dikirim mt-4">
      @if (count($perludikirims) > 0)
        <div class='pengiriman_wrapper'>
          @foreach ($perludikirims as $perludikirim)
            ...
            <div class="modal fade" id="detailModal{{ $perludikirim->id }}" tabindex="-1"
                    ...
                    <div class="modal-body">
                      ...
                      <div class="bukti_kamera d-none">
                        ...
                        <input type="file" accept="image/*" capture="camera" class="form-control"
                          name="bukti_kamera" onchange="prevImgKamera()">
                      </div>
                    </div>
                    <div class="modal-footer">
      ...
      @else
        <p class="mb-o text-danger text-center">Tidak Ada Data</p>
      @endif
    </div>

    <div class="sudah_sampai d-none mt-4">
      @if (count($sudahsampais) > 0)
        <div class='pengiriman_wrapper'>
