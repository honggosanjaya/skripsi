  ...
  <form method="POST" action="/administrasi/datacustomer/ubahcustomer/{{ $customer->id }}"
    ...
    <div class="my-3">
      ...
      <input type="text" class="form-control @error('keterangan_alamat') is-invalid @enderror" id="keterangan_alamat"
        name="keterangan_alamat" value="{{ old('keterangan_alamat', $customer->keterangan_alamat) }}">
    ...
    <div class="my-3">
      ...
      <select class="form-select" name="status">
        @foreach ($statuses as $status)
          @if (old('status', $customer->status) == $status->id)
    ...
    @if ($customer->status_limit_pembelian)
      <div class="my-3">
        <label for="status_limit_pembelian" class="form-label">Status Limit Pembelian</label>
        <input type="text" class="form-control" id="status_limit_pembelian" name="status_limit_pembelian"
          value="{{ $customer->status_limit_pembelian }}" disabled readonly>
      </div>
    @endif
