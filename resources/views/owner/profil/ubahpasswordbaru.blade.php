...
@section('breadcrumbs')
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="/owner/profil">Profil</a></li>
  ...
  <div class="pt-4 px-5">
    <div class="row justify-content-center">
      <div class="col-8">
        ...
        <form method="POST" action="/owner/profil/gantipassword/{{ auth()->user()->id }}">
          @csrf
          <div class="mb-3">
          ...
          <div class="row justify-content-end mt-4">
            <div class="col d-flex justify-content-end">
              <a href="/owner/profil" class="batalkanAksi_btn btn btn-danger me-3"><span class="iconify fs-4 me-1"
