  ...
  <div class="pt-4 px-5">
    <div class="row mt-5">
      <div class="col-6">
        <div class="informasi-list d-flex flex-column">
          <span><b>Staf pengaju</b> {{ $opname->linkStaff->nama }}</span>
    ...
    <div class="row justify-content-end mt-4">
      <div class="col d-flex justify-content-end">
        <form action="/supervisor/stokopname/tolak/{{ $opname->id }}" method="POST">
          @csrf
        ...
        <form action="/supervisor/stokopname/setuju/{{ $opname->id }}" method="POST">
          @csrf
