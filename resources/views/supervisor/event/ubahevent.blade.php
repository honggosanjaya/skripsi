      ...
      <form id="form_submit" class="form-submit" method="POST"
          ...
          <div class="row">
            <div class="col-3">
              ...
              <input type="number" class="form-control @error('potongan_diskon') is-invalid @enderror"
                id="potongan_diskon" name="potongan_diskon" value="{{ old('potongan_diskon', $diskon_potongan) }}"
          ...
          <div class="row">
            ...
            <div class="col-6">
              ...
              <input type="date" class="form-control @error('tanggal_selesai') is-invalid @enderror"
                ...
                value="{{ date('Y-m-d', strtotime($eventStatus->date_end)) }}">
        ...
        <div class="row justify-content-end mt-4">
          <div class="col-3 d-flex justify-content-end">
            ...
            <a href="/supervisor/event/hapusevent/{{ $eventStatus->id }}" type="button"
